	...
	// depending on your theme.
		...
		if (is_user_logged_in()) {
			...
			<li id="menu-item-logged-out-user" class="'.$class.'">
				<a href="http://proyectomariovillalba.comuf.com/?page_id=152">
					'.__('Log in').'
				</a>
			</li>
			';
...
function my_login_form_shortcode() {
	...
	return wp_login_form( array( 'echo' => false , 'redirect' => 'http://proyectomariovillalba.comuf.com/') ).'<div id="lost"><a href="'.wp_lostpassword_url().'" title="Lost Password">Lost Password?</a></br><a href="http://proyectomariovillalba.comuf.com/wp-login.php?action=register">Register</a></div>';
